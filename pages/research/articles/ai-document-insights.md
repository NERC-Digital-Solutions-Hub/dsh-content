...
description: "Using AI to make documents more accessible through automated summarisation and question-answering (RAG)."
date: "2025-11-10"
tags:
  - AI
  - RAG
...
![Architecture diagram for the RAG pipeline](./ai-document-insights/architecture-extract-descriptions.svg)
...
![Architecture diagram for the summarization process](./ai-document-insights/architecture-summarise.svg)
